## 2026-09-07 06:06 追加目視結果

Saturnも、操作側フォーカス後のXiaomiタスクバー非表示と中央の指へのカーソル・粒子の追従をユーザーが `ok` と確認。対象055537 trialはその後通常終了、PID/SHM解放済み。これで今回の修正後に確認したStorm・Spheres・Saturnの範囲では目視合格。全OS操作や他の未試験シーンへ合格を拡張しない。

# Stormのタスクバー露出：再現と最小修正

## 05:52：Stormのタスクバー非露出と中央反応を人間が確認

ユーザーが「タスクバーが出ず、粒子が手から押し広げられる」と明示回答。修正版Stormを表示してAcer側Codexをクリックした条件のタスクバー非露出と中央開掌反発を合格とする。他のGLFWシーン・全切替パターン・左右操作不能帯の合格へは広げない。

先行混在trial051941は05:49:50にduration_reached/exit0/1800.875秒/switch3/promotion4で終了。対象Manager6788/外側10936/Storm10920/wrapper27308の稼働なしとSHM不在を、新試験起動前に確認した。これは混在30分で、単一30分や20回反復の合格ではない。
