...
def main():
    ...
    while running:
        ...
        # 既存の軌跡だけを薄くし、透明背景は汚さない
        trail_surface.fill((245, 245, 245, 245), special_flags=pygame.BLEND_RGBA_MULT)
        ...
        for p in pointers:
            if p.has_target:
                ...
                for i in range(branches):
                    ...
                    draw_fractal(trail_surface, p.current_x, p.current_y, length, angle, depth, depth, hue_base, time_val, p.twist_factor, p.fractal_type)
