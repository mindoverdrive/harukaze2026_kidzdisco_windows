...
更新時刻: 2026-09-07 03:47 Particle Storm不足確認開始

## 最優先の再開位置（03:47）

- Spider修正後の目視をユーザーがOK。単一30分再起動なし、目視後の対象PID/SHM残留なし。終了時例外は解消済みとはしない。
- 現在はParticle Stormの四隅確認だけを提示して結果待ち。trial `kids_trial_20260907_034658_174238400`、15分上限、Manager24104/scene25540/wrapper27160/外側2436。FIRST_FRAME3.672秒、露出-4/zoom176一時適用、保存なし。
