...
候補プロファイルは1280×720、MJPG、30fps要求、露出-5。初期の短時間試験は約16fps、後の再起動では約30fpsを観測した。差の原因は未確定なので、毎回Camera diagnosticと継続取得を確認する。詳細は [CAMERA_RUNTIME_CHECK_20260906.md](CAMERA_RUNTIME_CHECK_20260906.md) を参照。
...
- 確認済み: 既存映像用Pythonのpreflight、実C922nの取得、初回描画通知、短時間の3回切替と正常終了。露出-5の要求と読戻しが一致した。
