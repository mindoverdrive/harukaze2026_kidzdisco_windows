...
**17時台の判定・自動確認は以下の履歴として保持する。** 当時はSpheresを候補として継続し大人の操作確認へ進め、暗い中央テスト後にはいったん次工程を保留した。その後の照明変更とSpheres・Dotsの成人操作結果は冒頭の最新記録を参照する。合成画像の5点変換は最大0.317pxの差で成功し、当時のDotsの実preflightも成功した。これら自動確認だけで、実際の中央操作や子供・本番採用を合格としたわけではない。
