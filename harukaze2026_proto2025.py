                ...
                def animate_wipe_left_to_right(canvas_img, ref_img, duration=0.3):
                    ...
                    for i in range(1, steps + 1):
                        ...
                        if cv2.waitKey(delay_ms) & 0xFF == ord('q'):
                            break
                    # Ensure completely cleared
                    canvas_img[:] = 0
                animate_wipe_left_to_right(canvas, image, duration=0.3)
